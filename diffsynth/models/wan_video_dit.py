...
class DiTBlock(nn.Module):
    ...
    # 🔥 1. 在参数末尾加上 sketch_context=None, **kwargs
    def forward(self, x, context, t_mod, freqs, sketch_context=None, **kwargs):
        ...
        # 🔥 2. 将 sketch_context 传递给 cross_attn
        x = x + self.cross_attn(self.norm3(x), context, sketch_context=sketch_context)
